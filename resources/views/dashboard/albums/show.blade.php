...
function updateBulkActions() {
    ...
    const moveContainer = document.getElementById('moveInputs');

    const deleteContainer = document.getElementById('deleteInputs');
    ...
    document
        ...
        .forEach(photo => {
            ...
            moveContainer.appendChild(input.cloneNode(true));
